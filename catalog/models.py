...
class Language(models.Model):
    language = models.CharField('Language', max_length=200, help_text="Enter a book language (e.g. English, Japan, "
                                                                      "Germany)")
...
class Book(models.Model):
    ...
    isbn = models.CharField('ISBN', max_length=13, help_text="13 Character <a href=\"https://www.usbn-international.org/content/what-isbn\">ISBN number</a>")
