...
class AuthorListViewTest(TestCase):
    ...
    def setUpTestData(cls):
        number_of_author = 13
        for author_num in range(number_of_author):
...
class LoanedBookByUserListViewTest(TestCase):
    ...
    def setUp(self):
        ...
        for book_copy in range(number_of_book_copies):
            ...
            status = 'm'
            BookInstance.objects.create(book=test_book, imprint='Unlikely Imprint, 2020', due_back=return_date,
    ...
    def test_only_borrowed_books_in_list(self):
        ...
        for bookintem in resp.context['bookinstance_list']:
            self.assertEqual(resp.context['user'], bookintem.borrower)
            self.assertEqual('o', bookintem.status)
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def setUp(self):
        ...
        return_date = datetime.datetime.today() + datetime.timedelta(days=5)
        self.test_bookinstance1 = BookInstance.objects.create(book=test_book, imprint='Unlikely Imprint, 2020',
                                                              due_back=return_date, borrower=test_user1, status='o')

        return_date = datetime.datetime.today() + datetime.timedelta(days=5)
        self.test_bookinstance2 = BookInstance.objects.create(book=test_book, imprint='Unlikely Imprint, 2020',
    ...
    def test_form_renewal_date_initially_has_date_three_weeks_in_future(self):
        ...
        date_3_week_in_future = datetime.date.today() + datetime.timedelta(weeks=3)
        self.assertEqual(resp.context['form'].initial['renewal_date'], date_3_week_in_future)
